...
\begin{solution}
$B = (l+d)s = s, (d=o), L =64 B = N/Y \rightarrow N = Br N = 6M * log_2 64  = 6M * 6 = 36Mbps$
\end{solution}

\vspace{12pt}

\begin{exercise}
Saluran telepon memiliki bandwidth 4 KHz. Berapa jumlah maksimum bit yang dapat kami kirim menggunakan masing-masing teknik berikut? Misalkan d = O
\begin{itemize}
\item[a.] ASK
\item[b.] QPSK
\item[c.] 16-QAM
...
\begin{itemize}
\item[a.] $r = log_22 = 1 \quad \rightarrow \quad N =  [1/(1 + 0)] * 1 * (4 KHz) = 4 kbps $
\item[b.] $r = log_24 = 2 \quad \rightarrow \quad N =  [1/(1 + 0)] * 2 * (4 KHz) = 8 kbps $
\item[c.] $r = log_216 = 4 \quad \rightarrow \quad N =  [1/(1 + 0)] * 4 * (4 KHz) = 16 kbps $
\item[d.] $r = log_264 = 6 \quad \rightarrow \quad N =  [1/(1 + 0)] * 6 * (4 KHz) = 24 kbps $
\end{itemize}
\end{solution}
